                  ...
                  <div class="todo-card" :style="{ animationDelay: `${i * 0.04}s` }" @dblclick="openEditTodoModal(t)">
                    ...
                    <div class="todo-card-footer">
                      <div class="todo-card-meta">
                        ...
                        <span v-if="t.done_at" class="todo-card-time todo-card-time-done">完成 {{ formatTodoTime(t.done_at) }}</span>
                        <span v-else-if="t.updated_at && t.updated_at !== t.created_at" class="todo-card-time">更新 {{ formatTodoTime(t.updated_at) }}</span>
                        <span v-else-if="t.created_at" class="todo-card-time">{{ formatTodoTime(t.created_at) }}</span>
                      </div>
